...
// Mobile Admin v1 — Today screen (Screen 1) + persistent bottom navigation
// (Screen 4) from the approved mockup. Add Appointment and Appointment
// Detail land in following milestones; Schedule/Clients/Settings tabs are
// stubs, fleshed out in their own milestones.
