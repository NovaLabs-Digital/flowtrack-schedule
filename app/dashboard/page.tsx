...
export default async function DashboardPage() {
  ...
  let apptFields = "id, client_id, service_type, scheduled_for, status, notes, duration_minutes, scheduled_end, series_id, frequency_type, repeat_weeks, repeat_months, employee_id, actual_started_at, actual_completed_at, price_cents, team_color";
